...
import { ClientFrame, Icon, ActiveButton, InactiveButton } from './Components'
...
const BlockButton: React.FC<any> = ({ format, icon }) => {
  ...
  const ButtonComp = isBlockActive(editor, format) ? ActiveButton : InactiveButton;
  return (
    <ButtonComp
      onMouseDown={(event) => {
...
const MarkButton: React.FC<any> = ({ format, icon }) => {
  const editor = useSlate()
  const ButtonComp = isMarkActive(editor, format) ? ActiveButton : InactiveButton;
  return (
    <ButtonComp
      onMouseDown={(event) => {
        event.preventDefault()
